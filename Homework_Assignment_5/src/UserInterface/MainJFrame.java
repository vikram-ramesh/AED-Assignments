...
import BusinessPackage.BusinessConfiguration.ConfigureABusiness;
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    ConfigureABusiness configBus;
    public MainJFrame() {
        configBus = new ConfigureABusiness();
        business = configBus.Initialize("General Motors");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnUserLogin.setText("System Login");
    ...
    private void btnUserLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUserLoginActionPerformed
        ...
        LoginScreen panel = new LoginScreen(userProcessContainer,business);
        userProcessContainer.add("LoginScreen", panel);
